...
game.move_pawn(0, 1, 30, Action_NO_EXACT_MATCH.MOVE_FORWARD)
game.get_str_game_overview()
print()
print("avance de 30 cases pion 1 pour voir où il se situe")
game.move_pawn(1, 1, 30, Action_NO_EXACT_MATCH.MOVE_FORWARD)
game.get_str_game_overview()
print()
print("finir le tour de joueur 0")
game.move_pawn(0, 31, 25, Action_NO_EXACT_MATCH.MOVE_FORWARD)
game.get_str_game_overview()
print()
game.move_pawn(1, 31, 25, Action_NO_EXACT_MATCH.MOVE_FORWARD)
game.get_str_game_overview()
print()
print("les joueurs entrent en safe zone")
game.move_pawn(0, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
game.move_pawn(1, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
game.get_str_game_overview()
print("faire goal pour joueur 0")
game.move_pawn(0, 57, 6, Action_NO_EXACT_MATCH.REACH_GOAL)
game.get_str_game_overview()
print()
