...
class TestKillAction(unittest.TestCase):
    ...
    def test_kill_on_exit_action(self):
        ...
        self.assertIn(Action_NO_EXACT_MATCH.KILL, valid_actions[0])
        self.assertNotIn(Action_NO_EXACT_MATCH.MOVE_OUT, valid_actions[0])
        ...
        self.assertIn(Action_NO_EXACT_MATCH.MOVE_OUT, valid_actions[0])
        self.assertNotIn(Action_NO_EXACT_MATCH.KILL, valid_actions[0])
