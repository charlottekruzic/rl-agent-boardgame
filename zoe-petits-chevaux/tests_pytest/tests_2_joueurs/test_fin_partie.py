import pytest
from ludo_env import GameLogic, Action_NO_EXACT_MATCH
...
def test_fin_de_partie_tous_chevaux_2chevaux(game_2chevaux):
    ...
    game_2chevaux.move_pawn(0, 0, 6, Action_NO_EXACT_MATCH.MOVE_OUT)
    game_2chevaux.move_pawn(0, 1, 55, Action_NO_EXACT_MATCH.MOVE_FORWARD)
    game_2chevaux.move_pawn(0, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
    game_2chevaux.move_pawn(0, 57, 5, Action_NO_EXACT_MATCH.MOVE_IN_SAFE_ZONE)
    ...
    game_2chevaux.move_pawn(0, 62, 1, Action_NO_EXACT_MATCH.REACH_GOAL)
...
def test_fin_de_partie_tous_chevaux_3chevaux(game_3chevaux):
    ...
    game_3chevaux.move_pawn(1, 0, 6, Action_NO_EXACT_MATCH.MOVE_OUT)
    game_3chevaux.move_pawn(1, 1, 55, Action_NO_EXACT_MATCH.MOVE_FORWARD)
    game_3chevaux.move_pawn(1, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
    game_3chevaux.move_pawn(1, 57, 5, Action_NO_EXACT_MATCH.MOVE_IN_SAFE_ZONE)
    ...
    game_3chevaux.move_pawn(1, 62, 1, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_3chevaux.is_game_over() == False
    ...
    game_3chevaux.move_pawn(1, 62, 3, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_3chevaux.is_game_over() == False

    game_3chevaux.move_pawn(1, 62, 6, Action_NO_EXACT_MATCH.REACH_GOAL)
...
def test_fin_de_partie_tous_chevaux_4chevaux(game_4chevaux):
    ...
    game_4chevaux.move_pawn(1, 0, 6, Action_NO_EXACT_MATCH.MOVE_OUT)
    game_4chevaux.move_pawn(1, 1, 55, Action_NO_EXACT_MATCH.MOVE_FORWARD)
    game_4chevaux.move_pawn(1, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
    game_4chevaux.move_pawn(1, 57, 5, Action_NO_EXACT_MATCH.MOVE_IN_SAFE_ZONE)
    ...
    game_4chevaux.move_pawn(1, 62, 1, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_4chevaux.is_game_over() == False
    ...
    game_4chevaux.move_pawn(1, 62, 3, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_4chevaux.is_game_over() == False
    game_4chevaux.move_pawn(1, 62, 6, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_4chevaux.is_game_over() == False
...
def test_fin_de_partie_un_cheval_gagne_3chevaux(game_3chevaux):
    game_3chevaux.init_board()
    game_3chevaux.move_pawn(0, 0, 6, Action_NO_EXACT_MATCH.MOVE_OUT)
    game_3chevaux.move_pawn(0, 1, 55, Action_NO_EXACT_MATCH.MOVE_FORWARD)
    game_3chevaux.move_pawn(0, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
    game_3chevaux.move_pawn(0, 57, 5, Action_NO_EXACT_MATCH.MOVE_IN_SAFE_ZONE)
    assert game_3chevaux.is_game_over() == False
    game_3chevaux.move_pawn(0, 62, 1, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_3chevaux.is_game_over() == False


def test_fin_de_partie_un_cheval_gagne_4chevaux(game_4chevaux):
    game_4chevaux.init_board()
    game_4chevaux.move_pawn(0, 0, 6, Action_NO_EXACT_MATCH.MOVE_OUT)
    game_4chevaux.move_pawn(0, 1, 55, Action_NO_EXACT_MATCH.MOVE_FORWARD)
    game_4chevaux.move_pawn(0, 56, 1, Action_NO_EXACT_MATCH.ENTER_SAFEZONE)
    game_4chevaux.move_pawn(0, 57, 5, Action_NO_EXACT_MATCH.MOVE_IN_SAFE_ZONE)
    assert game_4chevaux.is_game_over() == False
    game_4chevaux.move_pawn(0, 62, 1, Action_NO_EXACT_MATCH.REACH_GOAL)
    assert game_4chevaux.is_game_over() == False
